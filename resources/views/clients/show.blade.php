        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    ...
                    <h3>Actions</h3>
                    <p>
                        <a href="{{route('clients.edit',$client->id)}}"><button class="btn btn-primary"><i class="feather icon-edit" ></i> <strong>Editer</strong> </button></a>
                        @if ($client->statut_generique_id == 2)
                        <a href="{{route('client.cliStatut',$client->id )}}"><button class="btn btn-danger"><i class="fa fa-toggle-off"></i> <strong>Desactiver</strong></button></a>
                        @endif
                        @if ($client->statut_generique_id == 1)
                        <a href="{{route('client.cliStatut',$client->id )}}"><button class="btn btn-success"><i class="fa fa-toggle-on"></i> <strong>Activer</strong></button></a>
                        @endif
                    </p>
                </div>
            </div>
