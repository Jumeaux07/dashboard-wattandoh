            ...
            <form action="{{route('clients.update', $client->id)}}" method="post" >
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="nom_prenoms" value="{{$client->nom_prenoms}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: Kouassi Yves">
                        {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="exampleInputPassword1"> Numéro de téléphone 1<span class="text-danger" >*</span></label>
                        <input type="email" @readonly(true) name="phone1" value="{{$client->phone1}}" class="form-control" id="exampleInputPassword1" placeholder="Ex: asde@gmail.com">
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="exampleInputEmail1">Numéro de téléphone 2  <span class="text-danger" >*</span> </label>
                         <input type="text" name="phone2" value="{{$client->phone2}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: 0102030405">
                       {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                    </div>
                    <div class="form-group col-sm-6">
