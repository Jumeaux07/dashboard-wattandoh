            ...
            <div class="card-body">
                <div id="nestable-menu" class="button-list text-center mt-2">
                    ...
                    <div class="form-group col-sm-6">
                        <h2 for="exampleInputEmail1">La liste des Rendez vous du client : <span style="text-transform:uppercase;">{{$client->nom_prenoms}}</span> </h2>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @foreach ($client->rdv as $rdvs)
                                <tr>
                                    <td>{{$rdvs->annonceur->nom_prenoms}}</td>
