            ...
            <form action="{{route('budgets.update', $budget->id)}}" method="post" >
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="number" name="min" value="{{$budget->min}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: 000000001">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="number" name="max" value="{{$budget->max}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: 9999999999">
                        {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                    </div>
