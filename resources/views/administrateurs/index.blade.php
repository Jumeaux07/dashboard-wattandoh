                                        ...
                                        <div class="single-dropdown">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    @if ($administrateur->statut_generique_id == 2)
                                                    <a class="dropdown-item" href="{{route('administateur.statut',$administrateur->id )}}"> <i class="fa fa-toggle-off"></i> Desactiver</a>
                                                    @endif
                                                    @if ($administrateur->statut_generique_id == 1)
                                                    <a class="dropdown-item" href="{{route('administateur.statut',$administrateur->id )}}"> <i class="fa fa-toggle-on"></i> Activer</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
