...
<div class="breadcrumbbar">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{route('interdits.create')}}"><button class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Ajouter un Interdit </button></a>
            </div>
        </div>
    </div>
</div>
                        ...
                        <tbody>
                            @foreach ($interdits as $interdit)
                                <tr>
                                    ...
                                    @endif --}}
                                    <td>{{date('d-m-Y à H:i', strtotime($interdit->created_at))}}</td>
                                    <td>
                                        <div class="single-dropdown">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{route('interdits.show',$interdit->id )}}"> <i class="feather icon-eye"></i> Voir</a>
                                                    <a class="dropdown-item" href="{{route('interdits.edit', $interdit->id)}}"> <i class="feather icon-edit" ></i> Modifier</a>
                                                    {{-- @if ($commune->statut_generique_id == 2)
