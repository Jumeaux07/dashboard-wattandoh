        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="breadcrumb-list">
                ...
                <div class="card-header">
                    <h5 class="card-title" style="font-size:34px;">{{ $subtitle ?? '' }}</h5>
                </div>
            </div>
        ...
        <div class="card m-b-30">
            <div class="card-body">
                <div id="nestable-menu" class="button-list text-center mt-2">
                    ...
                    <form action="{{ Route('publicationtrier.index') }}" method="GET" >

                        <div class="row">

                            <div class="form-group col-sm-6">
                                <label for="exampleInputPassword1">Zone <span class="text-danger" >*</span></label>

                                <select name="quartier" class="form-control" id="exampleInputPassword1">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number" name="loyer" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select name="type_de_bien" id=""class="form-control" id="exampleInputPassword1">
                                    <option value="">Tous</option>
                                 
                                    @foreach ($typedebiens as $type_de_bien )
                                    <option value="{{ $type_de_bien->id }}">{{ $type_de_bien ->libelle }}</option>
