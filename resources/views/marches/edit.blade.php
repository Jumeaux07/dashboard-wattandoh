            ...
            <form action="{{route('marches.update', $marche->id)}}" method="post" >
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="reference" value="{{$marche->reference}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: jour....">
                        {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="exampleInputEmail1">Reference du  rendezvous  <span class="text-danger" >*</span> </label>
                        ...
                        <select name="rendezvous_id" class="form-control" id="exampleInputEmail1">
                            ...
                            <option value="{{$marche->rendezvous_id}}">{{ $rendezvou->reference }}</option>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {{-- <input type="number" name="publication_id" value="{{$marche->publication_id}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: 9999999999"> --}}
                        <select name="publication_id" class="form-control" id="exampleInputEmail1">
                            @foreach ($publications as $publication )
                            <option value="{{$marche->publication_id }}">{{ $publication->reference }}</option>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {{-- <input type="number" name="client_id" value="{{$marche->client_id}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: 9999999999"> --}}
                        <select name="client_id" class="form-control" id="exampleInputEmail1">
                            @foreach ($clients as $client )
                            <option value="{{$marche->client_id}}"> {{ $client->nom_prenoms }}</option>
