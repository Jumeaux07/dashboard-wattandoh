...
<!-- End Breadcrumbbar -->
 ...
 <div class="contentbar">
    <div class="card">
        <div class="container">
            <h1>Profil d'un type de marche </h1>
            <hr>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    ...
                    <h3>Actions</h3>
                    <p>
                        <a href="{{route('typedemarches.edit',$typedemarche->id)}}"><button class="btn btn-primary"><i class="feather icon-edit" ></i> <strong>Editer</strong> </button></a>
