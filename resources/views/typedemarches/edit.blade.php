 ...
 <div class="contentbar">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{route('typedemarches.update', $typedemarche->id)}}" method="post" >
                @method('put')
                {{ csrf_field() }}
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="exampleInputEmail1">type de marche  <span class="text-danger" >*</span> </label>
                        <input type="text" name="libelle" value="{{$typedemarche->libelle}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ex: type de marche">
