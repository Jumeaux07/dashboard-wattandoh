        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <p>Reference : {{$rapport->reference}}</p>
                    <p>Nom prenoms : {{$rapport->nom_prenoms}}</p>
                    <p>telephone : {{$rapport->telephone}}</p>
                    <p>loyer : {{$rapport->loyer}}</p>
                    <p>commission : {{$rapport->commission}}</p>
                    <p>pourcentage: {{$rapport->pourcentage}}</p>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    ...
                    <h3>Actions</h3>
                    <p>
                        <a href="{{route('rapports.edit',$rapport->id)}}"><button class="btn btn-primary"><i class="feather icon-edit" ></i> <strong>Editer</strong> </button></a>
